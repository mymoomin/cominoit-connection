    ...
    <div className="remix-app">
      ...
      <footer className="remix-app__footer">
        <div className="container remix-app__footer-content">
          <p>If you notice something wrong, please <a href="https://discord.gg/zaY7PTS" target="_blank" rel="noopener noreferrer">let us know on Discord</a></p>
        </div>
      </footer>
    </div>
  );
...
function DiscordRssLogo() {
  return (
    <svg 
      ...
      height="3.5rem"
    >
      <title id="logo-title">Discord RSS Logo</title>
      <rect width="400" height="400" rx="74" fill="#5c64f4"/>
      <circle fill="white" cx="100" cy="300" r="50"/>
      <path fill="white" d="M 50 50 a 300 300 0 0 1 300 300 h -50 A 250 250 0 0 0 50 100"/>
      <path fill="white" d="M 50 150 a 200 200 0 0 1 200 200 h -50 A 150 150 0 0 0 50 200"/>
    </svg>)
}

function StyledDiscordRssLogo() {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
    ...
    >
      ...
      <path d="M 50 50 a 300 300 0 0 1 300 300 h -50 A 250 250 0 0 0 50 100"/>
      <path d="M 50 150 a 200 200 0 0 1 200 200 h -50 A 150 150 0 0 0 50 200"/>
    </svg>)
}